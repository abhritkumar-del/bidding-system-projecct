                ...
                <form action="{{ route('admin.categories.update', $category) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="p-3" style="background: #f9fafb; border-radius: 10px;">
                            <i class="fas {{ $category->icon }} fa-3x" id="iconPreview" style="color: #667eea;"></i>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-info">
                        ...
                        <ul class="mb-0">
                            <li><strong>Total Products:</strong> {{ $category->products()->count() }}</li>
                            <li><strong>Active Products:</strong> {{ $category->activeProducts()->count() }}</li>
                            <li><strong>Created:</strong> {{ $category->created_at->format('d M, Y') }}</li>
                        </ul>
                    </div>
